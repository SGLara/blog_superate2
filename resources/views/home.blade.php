...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
        ...
        <div class="text">
            <h4>En el 2019 ¡Supérate! celebra su décimo quinto aniversario llegando a 10 Centros, 6 en El Salvador y 4 en
            Panamá.</h4>
        </div>
    </div>
    ...
    <div class="mySlides fade">
        ...
        <div class="text">
            <h4>¡Supérate!, nace como sueño visionario de un empresario salvadoreño, tomando vida en el 2004 con un centro y
            40 jóvenes en el Valle de San Andrés. Tres años después, desarrollamos una franquicia social que hasta la
    ...
    <div class="mySlides fade">
        ...
        <div class="text">
            ...
            responsabilidades, compromiso, entrega y especialmente el sueño de transformar nuestras vidas a través de la
            educación"</h4><br>
    ...
    <div class="mySlides fade">
        ...
        <div class="text">
            ...
            integral puedan optar a mejores oportunidades de formación profesional y de trabajo, para mejorar su calidad
    ...
    <div class="mySlides fade">
        ...
        <div class="text">
            ...
            <h4>La transformación de los jóvenes inicia desde el primer día en el Programa, la calidad del personal de los
    ...
    <div class="mySlides fade">
        ...
        <div class="text">
            <h2>VISIÓN</h2><br>
            <h4>Ser un programa de excelencia académica que contribuya a elevar el nivel educativo de la juventud de escasos
